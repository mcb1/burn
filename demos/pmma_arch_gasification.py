...
pmma_arch_gasification.py
Input module for gasification of a PMMA arch
...
q_ext       = (0.,0.,70e3)      # externally applied heat flux vector, W/m^2
h           = 10.               # W/m^2-K
T_inf       = 298.              # K

...
# thermophsyical properties don't effect solution
def k( z ):
    # W/m-K
    return 1.
...
ss          = True              # simulation is steady state
...
T_h         = Expression('T_inf + (T_p-T_inf)*sin(pi*x[0]/L_x)', 
                          T_inf=T_inf, T_p=T_p, L_x=L_x)
bcs_te      = [ (0, "Bottom", T_h),
